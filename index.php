...
<html lang="">
	<head>
		...
		<link rel="stylesheet" href="<?= $site_url ?>assets/css/basic_style.css">
		<link rel="stylesheet" href="<?= $site_url ?>assets/css/basic_responsive.css">
		<?php
		foreach ($page_info['files']['css'] as $path)
			echo '<link rel="stylesheet" href="'.$site_url . $path.'">';
		?>
		...
		<?php
		foreach ($page_info['files']['css'] as $path)
			echo '<script src="'.$site_url . $path.'" defer></script>';
		?>
